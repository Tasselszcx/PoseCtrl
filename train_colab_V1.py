...
from poseCtrl.models.pose_adaptor import VPmatrixPoints, ImageProjModel, VPmatrixPointsV1
...
class posectrl(nn.Module):
    ...
    def forward(self, noisy_latents, timesteps, encoder_hidden_states, point_embeds, image_embeds):
